const mappings = [
    ...
    {
        tag: '5F3C',
        name: 'Dynamic mutual authentication',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '6080',
        name: 'Commitment (e.g., a positive number less than the public RSA modulus in use)',
        type: '',
        length: '',
    },
    {
        tag: '6081',
        name: 'Challenge (e.g., a number, possibly zero, less than the public RSA exponent in use)',
        type: '',
        length: '',
    },
    {
        tag: '6082',
        name: 'Response (e.g., a positive number less than the public RSA modulus in use)',
        type: '',
        length: '',
    },
    {
        tag: '6083',
        name: 'Committed challenge (e.g., the hash-code of a commitment data object)',
        type: '',
        length: '',
    },
    {
        tag: '6084',
        name: 'Authentication code (e.g., the hash-code of one or more data fields and a commitment data object)',
        type: '',
        length: '',
    },
    {
        tag: '6085',
        name: 'Exponential (e.g., a public positive number for establishing a session key by a DH method)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '6280',
        name: 'Number of data bytes in the file, excluding structural information',
        type: '',
        length: '',
    },
    {
        tag: '6281',
        name: 'Number of data bytes in the file, including structural information if any',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '6285',
        name: 'Proprietary information, primitive encoding (i.e., not coded in BER-TLV)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '6287',
        name: 'Identifier of an EF containing an extension of the file control information',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '62A2',
        name: 'One or more pairs of data objects, short EF identifier (tag 88) - absolute or relative path (tag 51)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '6F',
        name: 'Template, File Control Parameters and File Management Data (FCI)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '77',
        name: 'Template, Response Message Format 2',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7A9F2X',
        name: "Internal progression value ('X'-is a specific index, e.g., an index referencing a counter of file selections)",
        type: '',
        length: '',
    },
    {
        tag: '7A9F3Y',
        name: "External progression value ('Y'-is a specific index, e.g., an index referencing an external time stamp)",
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7D82',
        name: 'Cryptogram (plain value coded in BER-TLV and including secure messaging data objects)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7D84',
        name: 'Cryptogram (plain value coded in BER-TLV, but not including secure messaging data objects)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7D86',
        name: 'Padding-content indicator byte followed by cryptogram (plain value not coded in BER-TLV)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7D99',
        name: 'Processing status of the secured response APDU (new SW1-SW2, two bytes)',
        type: '',
        length: '',
    },
    {
        tag: '7D9A',
        name: 'Input data element for the computation of a digital signature (the value field is signed)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DA0',
        name: 'Input template for the computation of a hash-code (the template is hashed)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DA2',
        name: 'Input template for the verification of a cryptographic checksum (the template is integrated)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DA8',
        name: 'Input template for the verification of a digital signature (the template is signed)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DAC',
        name: 'Input template for the computation of a digital signature (the concatenated value fields are signed)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DAE',
        name: 'Input template for the computation of a certificate (the concatenated value fields are certified)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DB0',
        name: 'Plain value coded in BER-TLV and including secure messaging data objects',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DB2',
        name: 'Plain value coded in BER-TLV, but not including secure messaging data objects',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DBC',
        name: 'Input template for the computation of a digital signature (the template is signed)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7DBE',
        name: 'Input template for the verification of a certificate (the template is certified)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '7F4980',
        name: 'Algorithm reference as used in control reference data objects for secure messaging',
        type: '',
        length: '',
    },
    {
        tag: '7F4981',
        name: 'RSA Modulus (a number denoted as n coded on x bytes), or DSA First prime (a number denoted as p coded on y bytes), or ECDSA Prime (a number denoted as p coded on z bytes)',
        type: '',
        length: '',
    },
    {
        tag: '7F4982',
        name: 'RSA Public exponent (a number denoted as v, e.g., 65537), or DSA Second prime (a number denoted as q dividing p-1, e.g., 20 bytes), or ECDSA First coefficient (a number denoted as a coded on z bytes)',
        type: '',
        length: '',
    },
    {
        tag: '7F4983',
        name: 'DSA Basis (a number denoted as g of order q coded on y bytes), or ECDSA Second coefficient (a number denoted as b coded on z bytes)',
        type: '',
        length: '',
    },
    {
        tag: '7F4984',
        name: 'DSA Public key (a number denoted as y equal to g to the power x mod p where x is the private key coded on y bytes), or ECDSA Generator (a point denoted as PB on the curve, coded onz bytes)',
        type: '',
        length: '',
    },
    {
        tag: '7F4985',
        name: 'ECDSA Order (a prime number denoted as q, order of the generator PB, coded on z bytes)',
        type: '',
        length: '',
    },
    {
        tag: '7F4986',
        name: 'ECDSA Public key (a point denoted as PP on the curve, equal to x times PB where x is the private key, coded onz bytes)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '9F02',
        name: 'Authorised Amount (Numeric)',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '9F22',
        name: 'Public Key Index, Certification Authority, Terminal',
        type: '',
        length: '',
    },
    {
    ...
    {
        tag: '9F24',
        name: 'Payment Account Reference (PAR) generated or linked directly to the provision request in the token vault',
        type: 'ans 24',
        length: '24',
    },
    {
    ...
    {
        tag: '9F72',
        name: 'Consecutive Transaction Limit (Internationalâ€”Country)',
        type: 'b',
        length: '1',
    },
    {
    ...
    {
        tag: 'CA',
        name: 'Lower cumulative offline transaction amount',
        type: 'H',
        length: '',
    },
    {
...
const tags = [
    ...
    },
    {
        ...
        length: '1 [B]',
        description:
            "Indicates the type of financial transaction, represented by the first two digits of the ISO 8583:1987 Processing Code. Requested in CDOL1. Possible values are: '00' for a purchase transaction, '01' for a cash advance transaction, '09' for a purchase with cashback, '20' for a refund transaction",
        comment: 'M',
    },
    {
        tag: '9D',
    ...
    },
    {
        ...
        length: '1 [B]',
        description:
            'Contains instructions from the Terminal on how to proceed with the transaction if the AC requested by the Terminal does not match 1) The AC proposed by the Kernel 2) The update of the slot data has failed',
    },
    {
        tag: 'DF810B',
        name: 'DS Summary Status',
        ...
        length: '1 [B]',
        description:
            'Information reported by the Kernel to the Terminal about: 1. The consistency between DS Summary 1 and DS Summary 2 (successful read) 2. The difference between DS Summary 2 and DS Summary 3 (successful write). This data object is part of the Discretionary Data.',
    },
    {
        tag: 'DF810C',
        name: 'Kernel ID',
    ...
    },
    {
        ...
        length: 'Variable',
        description:
            'Terminals that are Online Capable must be capable of performing Partial Online contactless transactions. Online capable terminals may optionally provide support for a Full Online contactless transaction.',
    },
    {
        tag: 'N/A',
    ...
    },
    {
        ...
        length: 'Variable',
        description:
            'A set of persistent data elements representing the context of an ongoing online transaction. The Online Transaction Context is saved by the Kernel before returning the Online Request outcome, and is restored if Kernel is restarted for an Issuer Update.',
        comment: 'C',
    },
    {
        tag: 'N/A',
    ...
    },
    {
        ...
        length: '6 [B]',
        description:
            'Indicates the contactless floor limit of the reader for a specific AID. If the transaction amount is greater than the Reader Contactless Floor Limit, then the reader requires online processing for the transaction.',
    },
    {
        tag: 'N/A',
        name: 'Reader Contactless Floor Limit',
    ...
    },
    {
        ...
        length: '6 [B]',
        description:
            'Indicates the contactless transaction limit of the reader for a specific AID. If the transaction amount is greater than or equal to the Reader Contactless Transaction Limit, then a contactless transaction is not permitted. Switching the transaction over to another interface is permitted.',
    },
    {
        tag: 'N/A',
        name: 'Reader Contactless Transaction Limit',
    ...
    },
    {
        ...
        length: '6 [B]',
        description:
            'Indicates the CVM limit of the reader for a specific AID. If the transaction amount is greater than or equal to the Reader CVM Required Limit, then the reader requires a CVM for the transaction.',
    },
    {
        tag: 'N/A',
        name: 'Reader CVM Required Limit',
    ...
    },
    {
        ...
        length: 'Variable',
        description:
            'A set of persistent Kernel 5 parameters involved in the management of torn EMV transactions. It consists of:  1. Recovering from Torn EMV Transaction Flag 2.Torn Track 2 Data  3. Torn CDA Hash Data Buffer',
        comment: 'C',
    },
    {
        tag: 'N/A',
        ...
        length: '2 [B]',
        description:
            'Present if the Combination supports Issuer Update as Acquirer Option (EMV Mode only). In case of Online Request with Present and Hold outcome, this parameter corresponds to the time after which cardholder is asked to remove the card. Value is given in units of 100ms.',
        comment: 'C',
    },
    {
        tag: 'N/A',
    ...
    },
    {
        ...
        length: 'Variable',
        description:
            'A copy of the PDOL related data and CDOL1 related data sent to the card during a torn transaction in EMV Mode. This copy is used to verify the CDA signature during the subsequent transaction recovery process.',
        comment: 'C',
    },
    {
        tag: 'N/A',
    ...
    },
    {
        ...
        length: '19 [B]',
        description:
            'A copy of the card Track 2 Equivalent Data, kept by the Kernel after a torn transaction in EMV Mode to ensure that the card presented for recovery is the same as for the torn transaction.',
        comment: 'C',
    },
    {
        tag: 'N/A',
    ...
    },
    {
        ...
        length: 'Variable',
        description:
            'An internal Kernel indicator storing the transaction mode selected for conducting the transaction. It admits the following values: Undefined Mode, EMV Mode, Magstripe  Mode, Legacy Mode',
        comment: 'M',
    },
    {
        tag: 'N/A',
    ...
    },
    {
        ...
        template: '',
        length: 'variable',
        description: '5F24 is an EMVCo EMV Tag - used in perso. When mapped to 006 the ‘DD’ is dropped from 5F24, when mapping from 006 the last day of the specified month (MM) is to be appended.',
    },
    {
        tag: 'DF14',
        name: 'Token Request Indicator',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: '5F34',
        name: 'Token Card Sequence Number',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF20',
        name: 'Funding PAN Expiration Date ',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF64',
        name: 'Customisation Asset Identifiers',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF7C',
        name: 'Server Identifier	Currently not required for eftpos',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: '5F20',
        name: 'Cardholder Name	EMVCo EMV Tag - used in perso',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF2B',
        name: 'Phone Number (Device Number)',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF31',
        name: 'IMEI/MEID (Last 2 characters)',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF32',
        name: 'Serial Number (Last 2 characters)',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF36',
        name: 'Android ID (Last 2 characters)',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF3A',
        name: 'Card On File Tenure (Weeks)',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF3B',
        name: 'Wallet Account Tenure (Weeks	',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF3C',
        name: 'Gaia Account Tenure (Weeks)',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF3D',
        name: 'Wallet Name mismatches Cardholder Name',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF42',
        name: 'Recommendation Algorithm Version',
        kernel: 'kernel_20',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF64',
        name: 'Customization Asset Identifiers List',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF69',
        name: 'Terms and Conditions Acceptance Date',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: '9F52',
        name: 'Merchant Type Indicator Limit 1',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: '9F54',
        name: 'Merchant Type Indicator Limit 2',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: '9F55',
        name: 'Merchant Type Indicator Limit 3',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: '9F56',
        name: 'Merchant Type Indicator Limit 4',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: '9F57',
        name: 'Merchant Type Indicator Limit 5',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF50',
        name: 'Issuer Proprietary Message',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'DF77',
        name: 'Tokenized Primary Account Number (T-PAN)',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
    ...
    {
        tag: 'E2',
        name: 'User Validation Methods List',
        kernel: 'kernel_21',
        source: '',
        format: '',
        template: '',
...
function getApplicationLable(encrypted) {
    let mapped_data = {};
        ...
        for (let i = 0; i < data.length; i++) {
            mapped_data[
                mappings
                    ...
                    .name.replace(/ /g, '_')
                    .toLocaleLowerCase()
            ] = getConvertedValue(data[i].value, mappings.find(({ tag: _tag }) => data[i].tag === _tag).type, mappings.find(({ tag: _tag }) => data[i].tag === _tag).length);
        }
    });
    return parseCardType(mapped_data['application_label']);
}
...
console.log(
    getApplicationLable(
        ''
    )
);
