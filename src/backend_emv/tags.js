const tags = [
  ...
  },
  {
    ...
    comment:
      "Due to limitations set by Kernel 4 mag-stripe mode, this must be set to 00 or be otherwise predictable by the Issuer.",
  },
  {
    tag: "5F34",
    name: "Application Primary Account Number (PAN) Sequence Number (PSN)",
  ...
  },
  {
    ...
    comment:
      "For this specification the Application Version Number must always be '0001'.",
  },
  {
    tag: "9F09",
    name: "Application Version Number",
  ...
  },
  {
    ...
    comment:
      "Byte 1: SFI containing the cyclic transaction log file. Byte 2: Maximum number of records in the transaction log file.",
  },
  {
    tag: "9F4E",
  ...
  },
  {
    ...
    comment:
      "'00' = online only solution supported,'01'= offline/online solution supported",
  },
  {
    tag: "9F7B",
  ...
  },
  {
    ...
    length: "1 [B]",
    description:
      "Contains the AC type to be requested from the Card with the GENERATE AC command. This is the outcome of Terminal Action Analysis.",
  },
  {
    tag: "N/A",
    ...
    length: "Variable",
    description:
      "Indicates whether the terminal supports an alternate payment interface to the contactless Reader.",
  ...
  },
  {
    ...
    length: "8 [B]",
    description:
      "A cryptogram generated by the Issuer Host System during an online transaction.",
  },
  {
    tag: "N/A",
    ...
    length: "4 [B]",
    description:
      "Proprietary data element indicating the exception conditions that occurred during Card Risk Management.",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "Payment system public key used for dynamic data authentication.",
    comment:
      "Value generated by the payment system CA and loaded to terminal by acquirer. Up to six public keys per payment system must be supported.",
  },
  {
    tag: "N/A",
    name: "Certification Authority Public Key",
    ...
    length: "Variable",
    description:
      "Payment system public key used for offline data authentication.",
  },
  {
    tag: "N/A",
    name: "Certification Authority Public Key",
  ...
  },
  {
    ...
    length: "1 [B]",
    description:
      "Proprietary data element indicating the version of the TC, AAC/ARQC algorithm used by the application.",
  },
  {
    tag: "N/A",
    ...
    length: "2 [B]",
    description:
      "Defines some acquirer options for the combination, e.g. modes supported.",
    comment: "M",
  },
  {
    tag: "N/A",
    ...
    length: "6 [B]",
    description:
      "Used in Kernel 5 Terminal Risk Management (EMV Mode only). Present if the Combination supports Floor Limit Check or Random Transaction Selection.",
    comment: "C",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "Proprietary internal indicator used during transaction processing to indicate that internal reader processes have indicated that the transaction should be declined.",
    comment:
      "This indicator is a transient value, initialized to a value of 0 at the beginning of the transaction. 1 = Offline 'decline required by reader'",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "Defines whether the terminal is configured to perform delayed authorisations.",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "1 [B]",
    description:
      "Value used in terminal risk management for random transaction selection - present if the Combination supports Random Transaction Selection (EMV Mode only).",
    comment: "C",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "1 [B]",
    description:
      "An internal working variable used to indicate the C-APDU that is currently being processed by the Card.",
  },
  {
    tag: "N/A",
    name: "nUN",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "Offline capable terminals are capable of performing offline contactless transactions.",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "Proprietary internal indicator used during transaction processing to indicate that internal reader processes have indicated that the transaction should be online requested.",
    comment:
      "This indicator is a transient value, initialized to a value of 0 at the beginning of the transaction.1 = Online required by reader",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "12 [B]",
    description:
      "A series of codes that identify the terminal capability, security data, and specific conditions present at the time a transaction took place at the point of service.",
  },
  {
    tag: "N/A",
    ...
    length: "Variable",
    description:
      "Contains issuer data for transmission to the card in the Issuer Authentication Data of an online transaction.",
  },
  {
    tag: "N/A",
    name: "Reader Contactless Floor Limit",
  ...
  },
  {
    ...
    length: "6 [B]",
    description:
      "Indicates the limit for which contactless transactions can be conducted.",
  },
  {
    tag: "N/A",
    name: "Reader CVM Required Limit",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "Internal Kernel variable (Boolean) set to TRUE when the Kernel attempts to recover from a torn transaction (EMV Mode only).",
    comment: "C",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "Indicates whether a timeout function should be started with the time specified.",
  },
  {
    tag: "N/A",
    ...
    length: "Variable",
    description:
      "Buffer used to concatenate records that are involved in offline data authentication.",
  },
  {
    tag: "N/A",
    ...
    length: "Variable",
    description:
      "This flag indicates whether the reader is able to use a single unit of currency check to determine whether the card is genuine and active.",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "A file of account numbers to be used by the terminal, for which it has been predetermined that there shall be an authorisation decision of denial.",
  },
  {
    tag: "N/A",
    ...
    length: "3 [B]",
    description:
      "Defines the Cardholder Verification Methods and other reader capabilities (online capability, contact EMV capability) for the Combination.",
    comment: "M",
  },
  {
    tag: "N/A",
  ...
  },
  {
    ...
    length: "Variable",
    description:
      "Specifies the range in which the unpredictable number must be generated in for contactless mag-stripe mode.",
    comment:
      "The default minimum range is 0 to 60. Note that the number range is inclusive, so a range of 0 to 60 should be capable of generating 61 integer numbers in the range 0 to 60.",
  },
  {
    tag: "N/A",
    ...
    length: "Variable",
    description:
      "This flag indicates whether a transaction with a zero amount is permitted.",
    comment:
      "The default minimum range is 0 to 60. Note that the number range is inclusive, so a range of 0 to 60 should be capable of generating 61 integer numbers in the range 0 to 60.",
  },
  {
  ...
  },
  {
    ...
    length: "variable",
    description:
      "5F24 is an EMVCo EMV Tag - used in perso. When mapped to 006 the ‘DD’ is dropped from 5F24, when mapping from 006 the last day of the specified month (MM) is to be appended.",
  },
  {
    tag: "DF14",
