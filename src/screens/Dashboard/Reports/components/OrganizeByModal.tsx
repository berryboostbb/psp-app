import { AppText, AppView, VerticalSpacer } from "@components";
import React, { useState } from "react";
import { Image, Modal, StyleSheet, TouchableOpacity, View } from "react-native";
import { useSelector } from "react-redux";
import { languagePicker } from "@utils";
import { card, close, filter, person } from "@assets";
...
const tilesData: IconTextType[] = [
  { title: "Transactions", image: filter },
  { title: "Clerk/Server", image: person },
  { title: "Card Brands", image: card },
];
...
export default OrganizeByModal;
