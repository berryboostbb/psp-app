...
const TransactionsScreenshot = React.forwardRef(({ startDate, endDate, startTime, endTime, lastTransactionDate, transactionData }: Props, ref: any) => {
...
export default TransactionsScreenshot;
